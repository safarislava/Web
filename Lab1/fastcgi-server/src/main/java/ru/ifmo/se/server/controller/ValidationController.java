...
public class ValidationController {
    private static final BigDecimal[] xValidValues = new BigDecimal[]{
            new BigDecimal("-2"),
            new BigDecimal("-1.5"),
            new BigDecimal("-1"),
            new BigDecimal("-0.5"),
    ...
    private static final BigDecimal[] rValidValues = new BigDecimal[]{
            new BigDecimal("1"),
            new BigDecimal("1.5"),
            new BigDecimal("2"),
            new BigDecimal("2.5"),
    ...
    public static void validate(PointRequest pointRequest) throws IllegalArgumentException {
